    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2020 -  ltd company | <a href="https://www.sourcecodester.com/" target="_blank">Coder</a></div></div>
        </footer>
